...
def predict_country(img_resized, biome_predict):
    ...
    img_model_sized = cv2.resize(img_resized, IMAGE_RESIZE)
    ...
    first_proba = result[first_index]
    ...
    return first_guess, second_guess, third_guess, first_proba, second_proba, third_proba
